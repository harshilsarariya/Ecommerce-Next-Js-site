      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-12 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full lg:h-auto px-24 h-64 object-cover object-top rounded"
              src="https://m.media-amazon.com/images/I/51gLOzE-6TL._UX679_.jpg"
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <button
                  onClick={() => {
                    addToCart(
                      ...
                      1,
                      499,
                      "Were The Code (XL, Red)",
                      "XL",
                      "Red"
                    );
                  }}
                  className="flex ml-14 text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded"
                >
                  Add to Cart
                </button>
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                ...
                <button
                  ...
                  className="text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hove:bg-orange-600 rounded"
                >
                  Check
                </button>
              </div>
